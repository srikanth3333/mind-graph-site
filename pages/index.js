  ...
  return (
   <div className="page">
      ...
      <div className="roundedcircle_left"></div>
        {/* <img src="Ellipse1.png" className="shape" /> */}
            ...
            <div className="roundedcircle_right"></div>
              ...
              <div className="row">
                <div className="col-lg-2">
                    <img src="ai.png" className="img-fluid" alt="" />
                ...
                <div className="col-lg-2">
                    <img src="data.png" className="img-fluid" alt="" />
                    <div className="text-box">
                      <h5>DATATIZATION</h5>
                ...
                <div className="col-lg-2">
                    <img src="digi.png" className="img-fluid" alt="" />
                    <div className="text-box">
                ...
                <div className="col-lg-2">
                    <img src="auto.png" className="img-fluid" alt="" />
                    <div className="text-box">
                      <h5>AUTOMATION</h5>
            ...
            <div className="col-lg-12 mt-5 pb-5">
              <div className="row">
                <div className="col-lg-4 position-relative">
                  <img src="a-1.png" className='a-icon' alt="" />
                  <h6>IIoT</h6>
                ...
                <div className="col-lg-4 position-relative">
                  <img src="a-2.png" className='a-icon' alt="" />
                ...
                <div className="col-lg-4 position-relative">
                  <img src="a-3.png" className='a-icon' alt="" />
                  <h6>RPA</h6>
              ...
              <div className="col-lg-3">
                <div className="card">
                  <div className="card-body py-5">
                      <img src="testi.png" className="testi-icon" alt="" />
